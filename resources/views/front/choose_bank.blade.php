...
@section('content')
    <section
      id="content"
      class="w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-8">
      ...
      <div class="flex flex-1 flex-col h-full justify-center px-4 gap-8">
        <div class="px-[35px] w-full h-48 flex shrink-0 justify-center">
          <img
            src="{{asset('assets/backgrounds/Bank-Account-Illustration.png')}}"
        ...
        <form method='POST' action="{{ route('front.choose_bank_store', $packageBooking) }}" class="flex flex-col gap-8">
          ...
          <button
            type="submit"
            class="p-[16px_24px] rounded-xl bg-blue w-full text-white text-center hover:bg-[#06C755] transition-all duration-300"
          >
            Checkout
          </button>
        </form>
