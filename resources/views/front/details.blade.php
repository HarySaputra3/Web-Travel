...
@section('content')
    <section id="content" class=" w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <div id="image-details" class="px-4 flex flex-col gap-2">
          ...
          <a href="{{ $packageTour->link }}" class="thumbnail-option w-[80px] h-[80px] flex shrink-0 rounded-xl border-2 overflow-hidden mx-auto border-blue">
              <embed src="{{ $packageTour->link }}" class="w-full h-full object-cover object-center" alt="thumbnail">
            </a>
        </div>
        ...
        <div class="navigation-bar fixed bottom-0 z-50 max-w-[1080px] w-full h-[85px] bg-white rounded-t-[25px] flex items-center justify-between px-6">
