...
@section('content')
    <section id="content" class="w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
      ...
      <form action="{{ route('front.book.store', $packageTour->slug) }}" method="POST" class="flex flex-col gap-8">
        ...
        <div
          class="navigation-bar fixed bottom-0 z-50 w-full h-[85px] bg-black rounded-t-[25px] flex items-center justify-between px-6 shadow-[-6px_-8px_20px_0_#00000008]"
        >
          <div class="flex flex-col justify-center gap-1">
            ...
            <p
              id="grandtotal"
              class="text-[#EED202] font-semibold text-lg leading-[26px] tracking-[0.6px]"
            ></p>
          </div>
          <button
            type="submit"
